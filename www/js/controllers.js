...
.controller('registrationCtrl', ['$scope', '$stateParams', 'BlankFactory', '$ionicPopup', '$ionicHistory', '$state', '$rootScope', '$localStorage', '$ionicLoading', '$http',// The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
// You can include any angular dependencies as parameters for this function
// TIP: Access Route Parameters for your page via $stateParams.parameterName
function ($scope, $stateParams, BlankFactory, $ionicPopup, $ionicHistory, $state, $rootScope, $localStorage, $ionicLoading,$http) {
    ...
    $scope.getdata = function () {
        $http.get("http://samacharabharati.org/volunteer_api.php/about_details_telugu/GET").then(function (res) {
